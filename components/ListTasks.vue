  ...
  <div>
    <div class="">
      ...
      <div class="globalOptions">
        <button @click="handleChangeAllTasksStatus">Cambiar estados</button>
        <button @click="handleDeleteAllTasks">Borrar tareas</button>
      </div>
    </div>
...
watch(
  () => props.filterTasks,
  (value) => {
    tasks.value = value[0] || store.tasks;
  }
);
